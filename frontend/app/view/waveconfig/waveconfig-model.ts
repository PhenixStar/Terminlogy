    ...
    return [
        {
            ...
            path: "settings.json",
            language: "json",
            docsUrl: "https://docs.terminolgy.io/config",
            hasJsonView: true,
        },
        {
            name: "Connections",
            ...
            language: "json",
            docsUrl: "https://docs.terminolgy.io/connections",
        ...
        },
        {
            ...
            path: "widgets.json",
            language: "json",
            docsUrl: "https://docs.terminolgy.io/customwidgets",
            hasJsonView: true,
        },
        {
            name: "Terminolgy AI Modes",
            path: "waveai.json",
            language: "json",
            description: "Local models and BYOK",
            docsUrl: "https://docs.terminolgy.io/waveai-modes",
        ...
        },
        {
            ...
            language: "json",
            docsUrl: "https://docs.terminolgy.io/tab-backgrounds",
            hasJsonView: true,
        },
        {
            name: "Secrets",
...
const deprecatedConfigFiles: ConfigFile[] = [
    ...
    },
    {
        ...
        language: "json",
        deprecated: true,
        docsUrl: "https://docs.terminolgy.io/ai-presets",
...
export class WaveConfigViewModel implements ViewModel {
    ...
    viewType = "waveconfig";
    viewIcon = atom("gear");
    viewName = atom("Terminolgy Config") // REBRAND;
