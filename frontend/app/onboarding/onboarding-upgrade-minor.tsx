                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="flex flex-row gap-4 items-center">
                            <div className="flex h-[52px] px-3 items-center rounded-lg bg-hover text-accent text-[24px]">
                                ...
                                <span className="font-bold ml-2 font-mono">Terminolgy AI</span>
                            </div>
                        ...
                        <div className="text-secondary leading-relaxed max-w-[600px] text-left">
                            <p className="mb-4">
                                Terminolgy AI is your terminal assistant with full context. It can read your terminal output,
                                analyze widgets, read and write files, and help you solve problems&nbsp;faster.
                            </p>
                            <p className="mb-4">
                                <span className="font-semibold text-foreground">New in v0.13:</span> Terminolgy AI now
