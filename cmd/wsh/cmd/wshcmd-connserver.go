...
func serverRun(cmd *cobra.Command, args []string) error {
	...
	if connServerDev {
		var err error
		// REBRAND: waveterm-connserver → terminolgy-connserver (connserver dev log file name)
		logFilePath := fmt.Sprintf("/tmp/terminolgy-connserver-%d.log", os.Getuid()) // was waveterm-connserver
